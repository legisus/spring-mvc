...
//            message = "Must be minimum 6 characters, at least one letter and one number")
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return id == user.id && firstName.equals(user.firstName) && lastName.equals(user.lastName) && email.equals(user.email) && password.equals(user.password) && role.equals(user.role) && myTodos.equals(user.myTodos) && otherTodos.equals(user.otherTodos);
    }
